...
class AppNotificationRepo extends BaseRepo{
  ...
  Future<ApiResponse<List<AppNotification>>> lazyLoadMine(LazyAppNotificationRequest request) async {
    return _service.lazyLoadMine(request).catchError((Object obj) {
      // non-200 error goes here.
      switch (obj.runtimeType) {
        case DioError:
          final res = (obj as DioError).response;
